...
-- Modified By			: Adrian Sullivan adriaan.sullivan@hotmail.com
-- Thanks to these people, in alphabetical order
/*If I missed your name and you think it should be here, just drop me a mail I will gladly add it, the script has been formed over 3 years and countless sources, so my apologies, and email me, mkay */
Brent Ozar; awesomeness@theawesomesqlman.awesome --note, this is a fictional email adress, but it should belong to Brent
Clayton Kramer; ckramer.kramer@gmail.com
Glenn Berry;  http://sqlserverperformance.wordpress.com/
John Huang; http://www.sqlnotes.info/2012/03/14/modification-count-of-stats/#more-1864						
Kendra Little; http://www.brentozar.com/archive/2012/02/developer-sql-server-transaction-log/
------------------------------------------------------------------ */
BEGIN
...
SET @MinChangePercentage = 0.00001
...
CREATE TABLE #Action_Statistics
	...
	, LastUpdated DATETIME
	 CONSTRAINT [Action_Stats_TempTable)PK_ID] PRIMARY KEY CLUSTERED 
	(
		[Id] ASC
...
BEGIN  
		...
		';
		PRINT 'Getting some Statstics statistics.. for DB: '+@Database  ;
	BEGIN TRY
